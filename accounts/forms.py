...
class RegistrationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'phone_number': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'e.g. 01012345678'}),
    ...
    def save(self, commit=True):
        ...
        user.is_active = False  # Account must be activated via email token
        if commit:
            user.save()
        return user
    ...
    def clean(self):
        ...
        if email and password:
            ...
            if not user.is_active:
                raise ValidationError(_("Your account is not activated yet. Please check your email for the activation link."))
...
class ProfileEditForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'country': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Egypt'}),
        }
...
class DeleteAccountForm(forms.Form):
    ...
    password = forms.CharField(
        label=_("Confirm Password"),
        widget=forms.PasswordInput(attrs={'class': 'form-control', 'placeholder': 'Enter your password to confirm deletion'}),
        help_text=_("Enter your password to permanently delete your account.")
    )
